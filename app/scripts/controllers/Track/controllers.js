'use strict';
angular.module('app')
    .controller('Track', function($scope, $element, $state, $stateParams, NgTableParams, RecordList) {
        ...
        function _view(id) {
            console.log('_view');
            $state.go('web.TrackView', { id: id });
        }

        function _add() {
            console.log('_add');
            $state.go('web.TrackAdd');
        }
